    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="admin_status2.php" class="active"><span class="las la-user-tie"></span>
                    ...
                    <div>
                        <h1>
                            <?php
                                ...
                                $query = "SELECT count(*) FROM `ts_brand` WHERE status='Active'";
                    ...
                    <div>
                        <h1>
                            <?php
                                ...
                                $query = "SELECT count(*) FROM `ts_brand` WHERE status='Inactive'";
                                $qresult = mysqli_query($conn, $query);
                                $row = mysqli_fetch_assoc($qresult);
                                $count = $row["count(*)"];
                                echo $count;   
