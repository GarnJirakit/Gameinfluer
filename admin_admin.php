    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="admin_admin.php" class="active"><span class="las la-user-shield"></span>
                    <span>แอดมิน</span></a>
                </li>
            </ul>
        </div>
                                   ...
                                   <thead>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $sql = "SELECT id, name, contact, email, registered_on FROM `admin`";
                                                ...
                                                while($row = $result-> fetch_assoc()) {
                                                    echo "<tr>
                                                            ...
                                                            <td>
                                                            <a href='admin.php?id=". $row["id"] ."' class='btn'>Delete</a>
                                                            </td>
                                                          </tr>";
                                                    }
                                                    echo "</table>";
