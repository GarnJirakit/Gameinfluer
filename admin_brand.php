    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="admin_brand.php" class="active"><span class="las la-user-tie"></span>
                    ...
                    <div>
                        <h1>
                            <?php
                                ...
                                $query = "SELECT count(*) FROM `ts_brand`";
                    ...
                    <div>
                        <p>เพศชาย :
                            <?php
                                ...
                                $query = "SELECT count(*) FROM `ts_brand` WHERE gender='ชาย'";
                                $qresult = mysqli_query($conn, $query);
                                $row = mysqli_fetch_assoc($qresult);
                                $count = $row["count(*)"];
                                echo $count;   
                        ...
                        <p>เพศหญิง :
                            <?php
                                ...
                                $query = "SELECT count(*) FROM `ts_brand` WHERE gender='หญิง'";
                                $qresult = mysqli_query($conn, $query);
                                $row = mysqli_fetch_assoc($qresult);
                                $count = $row["count(*)"];
                                echo $count;   
                        ...
                        <p>เพศ LGBTQ+ :
                            <?php
                                ...
                                $query = "SELECT count(*) FROM `ts_brand` WHERE gender='อื่น ๆ'";
                                $qresult = mysqli_query($conn, $query);
                                $row = mysqli_fetch_assoc($qresult);
                                $count = $row["count(*)"];
                                echo $count;   
            ...
            <div class="recent-grid">
                <div class="projects">
                    <div class="card">
                        ...
                        <h3 style="font-weight: normal;">รายชื่อแบรนด์ / เอเจนซี่</h3>
                        </div>
                        <div class="card-body">
                                   ...
                                   <thead>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $sql = "SELECT id, name, gender, company, business, job, birthday, province, contact, email, registered_on FROM `ts_brand`";
