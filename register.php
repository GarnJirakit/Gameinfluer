  ...
  <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 col-sm-8 col-xl-12 col-lg-12 col-md-12 font-poppins">
    <div class="wrapper wrapper--w680">
      <div class="card card-4">
        <div class="card-body">
          <h2 class="title colabout"><img src="images/influ.png" width="60" height="60" alt="">&nbsp; ลงทะเบียนอินฟลูเอนเซอร์</h2>
          <input>
              ...
              <div class="row row-space">
                ...
                <div class="col-12">
                  <div class="input-group">
                    ...
                    <input class="input--style-4" type="date" id="birthday" name="birthday" value="" min="1900-01-01" max="2022-12-31">
                  </div>
                </div>
                ...
                <div class="col-12">
                  <div class="input-group">
                    ...
                    <input class="input--style-4" list="browsers" name="province" id="browser" placeholder="เลือกจังหวัดของคุณ ...">
          ...
          <div style="">
            <a href="login1.php" class="btn btn-secondary popbut" type="submit" style="margin-left:55px;">เข้าสู่ระบบอินฟลูเอนเซอร์</a>
          </div>
