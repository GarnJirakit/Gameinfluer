...
<div class="container" style="padding-left:100px; padding-right:100px">
  ...
  <h2><i class="far fa-edit"></i>&nbsp;สร้างหน้าโปรไฟล์</h2> <br>
  <?php
  ...
  <form method="POST" action="#" enctype="multipart/form-data"> <br>
    <img src="" id="blah" alt="" style="width:25%; border-radius: 50%; margin-left: 370px;"> 
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="form-group">
          ...
          <input type="text" value="" class="form-control" id="nameinflu" placeholder="ใส่ชื่อของคุณ" name="nameinflu">
        </div>
      </div>
      ...
      <div class="col-lg-6">
        <div class="form-group">
          ...
          <input type="text" value="" class="form-control" id="time" placeholder="ตัวอย่าง: 5 ปี" name="time">
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="form-group">
          ...
          <input type="text" value="" class="form-control" id="cost" placeholder="เรทราคางานต่ำสุด (บาท)" name="cost">
        </div>
      </div>
      ...
      <div class="col-lg-6">
        <div class="form-group">
          ...
          <input type="text" value="" class="form-control" id="cost2" placeholder="เรทราคางานต่ำสุด (บาท)" name="cost2">
        </div>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <textarea style="outline: none; height:150px;" type="text" class="form-control" id="cost_description" placeholder="เช่น share Post แชร์รูปภาพจากเพจ = 500 บาท" name="cost_description"><?php echo $row['cost_description']; ?></textarea>
    </div>
      ...
      <div class="col-lg-6">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="facebook" placeholder="ตัวอย่าง: https://www.facebook.com/gameinfluer" name="facebook" value="<?php echo $row['facebook']; ?>">
            ...
            <input type="text" class="form-control" id="facebookCount" placeholder="ใส่จำนวนผู้ติดตาม" name="facebookCount" value="">
        </div>
      </div>
      ...
      <div class="col-lg-6">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="youtube" placeholder="ตัวอย่าง: https://www.youtube.com/c/gameinfluer" name="youtube" value="<?php echo $row['youtube']; ?>">
            <label for="email" style="font-weight: normal;">จำนวนผู้ติดตาม</label>
            <input type="text" class="form-control" id="youtubeCount" placeholder="ใส่จำนวนผู้ติดตาม" name="youtubeCount" value="">
        </div>
      </div>
    </div>
      ...
      <div class="col-lg-6">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="twitter" placeholder="ตัวอย่าง: https://www.facebook.com/gameinfluer" name="twitter" value="<?php echo $row['twitter']; ?>">
            <label for="email" style="font-weight: normal;">จำนวนผู้ติดตาม</label>
            <input type="text" class="form-control" id="twitterCount" placeholder="ใส่จำนวนผู้ติดตาม" name="twitterCount" value="">
      ...
      <div class="col-lg-6">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="ig" placeholder="ตัวอย่าง: https://www.instagram.com/gameinfluer" name="ig" value="<?php echo $row['ig']; ?>">
            <label for="email" style="font-weight: normal;">จำนวนผู้ติดตาม</label>
            <input type="text" class="form-control" id="igCount" placeholder="ใส่จำนวนผู้ติดตาม" name="igCount" value="">
        </div>
      </div>
    </div>
      ...
      <div class="col-lg-6">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="twitch" placeholder="ตัวอย่าง: https://www.twitch.tv/gameinfluer" name="twitch" value="<?php echo $row['twitch']; ?>">
            <label for="email" style="font-weight: normal;">จำนวนผู้ติดตาม</label>
            <input type="text" class="form-control" id="twitchCount" placeholder="ใส่จำนวนผู้ติดตาม" name="twitchCount" value="">
        </div>
      </div>
      ...
      <div class="col-lg-6">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="tiktok" placeholder="ตัวอย่าง: https://www.tiktok.com/@gameinfluer" name="tiktok" value="<?php echo $row['tiktok']; ?>">
            <label for="email" style="font-weight: normal;">จำนวนผู้ติดตาม</label>
            <input type="text" class="form-control" id="tiktokCount" placeholder="ใส่จำนวนผู้ติดตาม" name="tiktokCount" value="">
        </div>
      </div>
    </div>
    ...
    <h3><img src="https://media2.giphy.com/media/WNhxL5edM8Tn6aISYh/200w.gif?cid=82a1493boh529taple9oqfytqkjfzn9gz03ytdygbxod7p23&rid=200w.gif&ct=g" width="20"> รายละเอียด</h3> <br>
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="form-group">
          ...
          <input type="text" value="" class="form-control" id="game" placeholder="ใส่ประเภทเกม" name="game">
        </div>
      </div>
      ...
      <div class="col-lg-6">
        <div class="form-group">
          ...
          <input type="text" value="" class="form-control" id="love_game" placeholder="ใส่เกมที่ชอบ" name="love_game">
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="form-group">
          ...
          <input type="text" value="" class="form-control" id="contact" placeholder="ใส่เบอร์โทรของคุณ" name="contact">
        </div>
      </div>
      ...
      <div class="col-lg-6">
        <div class="form-group">
          ...
          <input type="email" value="" class="form-control" id="email" placeholder="ใส่อีเมลของคุณ" name="email">
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="form-group">
          ...
          <input type="text" value="" class="form-control" id="text1" placeholder="บอกเล่ารายละเอียดของงานชิ้นนี้" name="text1">
        </div>
      </div>
        <div class="col-lg-6">
          <div class="form-group">
          <h6 for="">ลิงก์เข้าชม</h6>
            <input type="text" value="" class="form-control" id="link1" placeholder="ลิงก์เข้ารับชมของงานชิ้นนี้" name="link1">
          </div>
        </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="form-group">
        <h6 for="">รายละเอียด</h6>
        <input type="text" value="" class="form-control" id="text2" placeholder="บอกเล่ารายละเอียดของงานชิ้นนี้" name="text2">
        </div>
      </div>
        <div class="col-lg-6">
          <div class="form-group">
            <h6 for="">ลิงก์เข้าชม</h6>
            <input type="text" value="" class="form-control" id="link1" placeholder="ลิงก์เข้ารับชมของงานชิ้นนี้" name="link2">
          </div>
        </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="form-group">
        <h6 for="">รายละเอียด</h6>
          <input type="text" value="" class="form-control" id="text3" placeholder="บอกเล่ารายละเอียดของงานชิ้นนี้" name="text3">
        </div>
      </div>
        <div class="col-lg-6">
          <div class="form-group">
            <h6 for="">ลิงก์เข้าชม</h6>
              <input type="text" value="" class="form-control" id="link3" placeholder="ลิงก์เข้ารับชมของงานชิ้นนี้" name="link3">
          </div>
        </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="form-group">
          <h6 for="">รายละเอียด</h6>
            <input type="text" value="" class="form-control" id="v_text1" placeholder="บอกเล่ารายละเอียดของงานชิ้นนี้" name="v_text1">
        </div>
      </div>
        <div class="col-lg-6">
          <div class="form-group">
          <h6 for="">ลิงก์เข้าชม</h6>
            <input type="text" value="" class="form-control" id="v_link1" placeholder="ลิงก์เข้ารับชมของงานชิ้นนี้" name="v_link1">
          </div>
        </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="form-group">
        <h6 for="">รายละเอียด</h6>
          <input type="text" value="" class="form-control" id="v_text2" placeholder="บอกเล่ารายละเอียดของงานชิ้นนี้" name="v_text2">
        </div>
      </div>
        <div class="col-lg-6">
          <div class="form-group">
            <h6 for="">ลิงก์เข้าชม</h6>
              <input type="text" value="" class="form-control" id="v_link2" placeholder="ลิงก์เข้ารับชมของงานชิ้นนี้" name="v_link2">
          </div>
        </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="form-group">
        <h6 for="">รายละเอียด</h6>
          <input type="text" value="" class="form-control" id="v_text3" placeholder="บอกเล่ารายละเอียดของงานชิ้นนี้" name="v_text3">
        </div>
      </div>
        <div class="col-lg-6">
          <div class="form-group">
            <h6 for="">ลิงก์เข้าชม</h6>
              <input type="text" value="" class="form-control" id="v_link3" placeholder="ลิงก์เข้ารับชมของงานชิ้นนี้" name="v_link3">
          </div>
        </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="form-group">
        <h6 for="">รายละเอียด</h6>
          <input type="text" value="" class="form-control" id="text4" placeholder="บอกเล่ารายละเอียดของงานชิ้นนี้" name="text4">
        </div>
      </div>
        <div class="col-lg-6">
          <div class="form-group">
            <h6 for="">ลิงก์เข้าชม</h6>
              <input type="text" value="" class="form-control" id="link4" placeholder="ลิงก์เข้ารับชมของงานชิ้นนี้" name="link4">
          </div>
        </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="form-group">
        <h6 for="">รายละเอียด</h6>
          <input type="text" value="" class="form-control" id="text5" placeholder="บอกเล่ารายละเอียดของงานชิ้นนี้" name="text5">
        </div>
      </div>
        <div class="col-lg-6">
          <div class="form-group">
            <h6 for="">ลิงก์เข้าชม</h6>
              <input type="text" value="" class="form-control" id="link5" placeholder="ลิงก์เข้ารับชมของงานชิ้นนี้" name="link5">
          </div>
        </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="form-group">
        <h6 for="">รายละเอียด</h6>
          <input type="text" value="" class="form-control" id="text6" placeholder="บอกเล่ารายละเอียดของงานชิ้นนี้" name="text6">
        </div>
      </div>
        <div class="col-lg-6">
          <div class="form-group">
            <h6 for="">ลิงก์เข้าชม</h6>
              <input type="text" value="" class="form-control" id="link6" placeholder="ลิงก์เข้ารับชมของงานชิ้นนี้" name="link6">
          </div>
        </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="form-group">
          <h6 for="">รายละเอียด</h6>
            <input type="text" value="" class="form-control" id="v_text4" placeholder="บอกเล่ารายละเอียดของงานชิ้นนี้" name="v_text4">
        </div>
      </div>
        <div class="col-lg-6">
          <div class="form-group">
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="form-group">
        <h6 for="">รายละเอียด</h6>
          <input type="text" value="" class="form-control" id="v_text5" placeholder="บอกเล่ารายละเอียดของงานชิ้นนี้" name="v_text5">
        </div>
      </div>
        <div class="col-lg-6">
          <div class="form-group">
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="form-group">
        <h6 for="">รายละเอียด</h6>
          <input type="text" value="" class="form-control" id="v_text6" placeholder="บอกเล่ารายละเอียดของงานชิ้นนี้" name="v_text6">
        </div>
      </div>
        <div class="col-lg-6">
          <div class="form-group">
    ...
    <div class="col-12">
        <button type="submit" name="submit" class="btn btn-dark col-3 popbut">ยืนยันสร้างโปรไฟล์</button>&nbsp;&nbsp;
