            ...
            <div class="row">
              ...
              <!-- <div class="col-md-6 text-right">
                ...
                <div class="row" id="result">
                    <?php
                        $sql = "SELECT * FROM `ts_user` ORDER BY cost DESC"; //*
                        $result = $db->query($sql);
                        while($row=$result->fetch_assoc()){
                    ?>
                            ...
                            <div class="card-deck" style="border: 2px solid #ccc; border-radius: 3px; padding: 10px;">
                                <div class="card border-secondary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a type="button" class="btn btn-primary bt2" data-toggle="modal" data-target="#exampleModal">ดูโปรไฟล์</a>
                                        <!-- <a href="#" id="myBtn" data-target="#myModal" class="btn btn-primary bt2">ดูโปรไฟล์</a> -->
                                        <br>
                                        <br>
                                    </div>
                                </div>
