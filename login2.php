...
if(isset($_REQUEST['submit']))
{
    ...
    $query=mysqli_query($db,"SELECT * FROM `ts_brand` WHERE `email`='$email' AND `password`='$password'");
...
<div class="container"> <br><br><br>
  <div class="box1">
    <h2><img src="https://i.pinimg.com/originals/43/0c/2f/430c2fcbf2d3cd1710bfbd0006dd385a.png" alt="" width="30px;"> เข้าสู่ระบบแบรนด์ / เอนเจนซี่</h2> <br>
    ...
    <a href="register_brand.php" class="btn btn-secondary col-3 popbut" type="submit">สมัครแบรนด์ / เอเจนซี่</a>
    </div>
